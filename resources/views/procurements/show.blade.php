                    ...
                    <tbody>
                        ...
                        @foreach($negotiations as $neg)
                            <tr>
                                ...
                                <td style="padding: 12px 8px; text-align: center; color: #000;">{{ $neg->hps ? 'Rp '.number_format($neg->hps,0,',','.') : '-' }}</td>
                                <td style="padding: 12px 8px; text-align: center; color: #000;">{{ $neg->budget ? 'Rp '.number_format($neg->budget,0,',','.') : '-' }}</td>
                                <td style="padding: 12px 8px; text-align: center; color: #000;">{{ $neg->harga_final ? 'Rp '.number_format($neg->harga_final,0,',','.') : '-' }}</td>
                                <td style="padding: 12px 8px; text-align: center; color: #000;">{{ $neg->tanggal_kirim ? $neg->tanggal_kirim->format('d/m/Y') : '-' }}</td>
                                <td style="padding: 12px 8px; text-align: center; color: #000;">{{ $neg->tanggal_terima ? $neg->tanggal_terima->format('d/m/Y') : '-' }}</td>
