                ...
                <div class="modal-body row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"
                                ...
                                data-raw-target="hpsRaw{{ $neg->negotiation_id }}"
                                value="{{ number_format($neg->hps ?? 0, 0, ',', '.') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"
                                class="form-control currency-input"
                                data-raw-target="budgetRaw{{ $neg->negotiation_id }}"
                                value="{{ number_format($neg->budget ?? 0, 0, ',', '.') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"
                                class="form-control currency-input"
                                data-raw-target="hargaFinalRaw{{ $neg->negotiation_id }}"
                                value="{{ number_format($neg->harga_final ?? 0, 0, ',', '.') }}">
                ...
                <div class="modal-body row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"
                                class="form-control currency-input"
                                data-raw-target="budgetRawCreate"
                                placeholder="0">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"
                                class="form-control currency-input"
                                data-raw-target="hargaFinalRawCreate"
                                placeholder="0">
